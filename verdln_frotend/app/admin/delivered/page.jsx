...
export default function AdminProofsPage() {
  ...
  const meta = {
    en: {
      title: "Delivered Loans & Proofs | Smart Agri-Loan",
      description: "View all delivered loans, documents, and repayment status.",
      keywords: "delivered loans, repayment, proofs, agri-loan",
      url: "https://yourdomain.com/admin-proofs",
      image: "/images/og/admin-proofs.png",
    },
    rw: {
      title: "Inguzanyo Zagejejwe & Inyemezabwishyu | Urubuga rw’Inguzanyo",
      description:
        "Reba inguzanyo zose zagejejwe, inyandiko n’ibisigaye kwishyura.",
      keywords: "inguzanyo zagejejwe, kwishyura, inyemezabwishyu, inguzanyo",
      url: "https://yourdomain.com/admin-proofs",
      image: "/images/og/admin-proofs.png",
    },
  }[lang || "en"];
          ...
          {filteredLoans.map((loan) => (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                ...
                <p className="flex items-center gap-1">
                  <Truck className="w-5 h-5" /> {t.supplier}:{" "}
                  {loan.supplier_name}
                </p>
                <p className="flex items-center gap-1">
