export const translations = {
  en: {
    ...
    welcomeSubtitle:
      "A digital platform that connects farmers and administrators for better farming support and services.",
  ...
  rw: {
    ...
    welcomeSubtitle:
      "Urubuga rukomatanyije abahinzi n’abayobozi kugira ngo ubuhinzi burusheho kugenda neza.",
    getStarted: "Tangira",
    register: "Iyandikishe",
    farmerDashboard: "Urupapuro rw’Umuhinzi",
    farmerDesc:
      "Ohereza ibisabwa, ukurikirane aho bigeze, urebe n’amateka yo kwishyura.",
    adminDashboard: "Urupapuro rw’Ubuyobozi",
    adminDesc:
      "Shyiraho ibyemezo ku bisabwa by’abahinzi, byemeze cyangwa ubyange, kandi ukurikirane imyishyurire.",
    ussd: "Ukoreshe USSD",
